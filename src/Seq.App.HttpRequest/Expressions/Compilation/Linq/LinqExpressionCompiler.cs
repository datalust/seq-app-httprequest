...
using Seq.App.HttpRequest.Expressions.Compilation.Transformations;
using Seq.App.HttpRequest.Templates.Compilation;
using Serilog.Events;
using ConstantExpression = Seq.App.HttpRequest.Expressions.Ast.ConstantExpression;
using Expression = Seq.App.HttpRequest.Expressions.Ast.Expression;
using ParameterExpression = System.Linq.Expressions.ParameterExpression;
using LX = System.Linq.Expressions.Expression;
using ExpressionBody = System.Linq.Expressions.Expression;
// ReSharper disable UseIndexFromEndExpression

namespace Seq.App.HttpRequest.Expressions.Compilation.Linq
{
    class LinqExpressionCompiler : SerilogExpressionTransformer<ExpressionBody>
    {
        ...
        protected override ExpressionBody Transform(AmbientNameExpression px)
        {
            if (px.IsBuiltIn)
            {
                var formatter = new CompiledMessageToken(_formatProvider, null);
